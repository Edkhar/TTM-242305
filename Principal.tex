...
\title{Sistema Automatizado de Monitoreo para la Alimentación y Producción de Gallina de Postura}
\unidad{\Upiita}
...
\Presidente{M. en E. Bárbara Mitzy Hernández Vargas}
\Titular{Ing. Omar Heredia Vargas}
%%%%%%%%%%%%%%%%%%%%%%% Datos del autor%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\alumnoa{García Trinidad Hugo Enrique}
\alumnob{Rubio Guerrero Edgar Miguel}
...
\asesora{Dr. Leonel Germán Corona Ramírez}
\asesorb{Dra. Norma Beatriz Lozada Castillo}
\asesorc{Dra. Indira Torres Sandoval}
%%%%%% Inicio de documento %%%%%%
\begin{document}
...
\dedicatoria              %%%modificar archivo dedica.tex Para empastado descomentar línea 355 del archivo de configuración
